      ...
      <main className="main">
        <div className="toolbar">
          ...
          <div className="toolbar-right">
            ...
            <button className="btn btn-ghost-purple">
              <span style={{ width: 8, height: 8, borderRadius: '50%', background: 'var(--rec-red)', display: 'inline-block' }}></span>
              {recording ? 'Recording' : 'Start meeting'}
            </button>
          </div>
        </div>
          ...
          <div className="content-inner">
            ...
            <div className="meta-row">
              ...
              <div className="participants">
                ...
                <div className="avatar" style={{ background: 'linear-gradient(135deg, oklch(0.78 0.10 200), oklch(0.62 0.14 220))' }}>M</div>
                <span className="p-count">2 participants</span>
              </div>
            </div>
    ...
    <div className="os-frame">
      <div className="window">
        <div className="titlebar">
          ...
          <div className="titlebar-title">Lyrola — Jerry &lt;-&gt; Marcus</div>
        </div>
        {inner}
      </div>
    </div>);
